...
public class HotelTest {
    ...
    /**
     * If the specified guest is checked in, he must be checked out,
     * 		i.e., afterwards, he must not have a room anymore,
    ...
    /**
     * ToString is difficult to test fully because there is no
     * 			restriction on the format of the returned String.
